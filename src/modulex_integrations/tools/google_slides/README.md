...
Create and edit Google Slides presentations from agents — manage slides, shapes, images, tables, and text via the Google Slides REST API (`slides.googleapis.com/v1`).

## Authentication

This integration supports a single auth method. Token validation hits Slides `GET /v1/presentations/1` (a 200 or 404 both confirm the token is accepted).
...
| `create_presentation` | Create a blank Google Slides presentation. | `title` |
